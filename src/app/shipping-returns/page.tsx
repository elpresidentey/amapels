  ...
  return (
    <div className="min-h-screen bg-ivory">
      ...
      <section className="section-shell pb-16">
        <div className="bg-brown-dark text-ivory rounded-2xl p-6 lg:p-8 text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-ivory/10 rounded-full mb-4">
            <Truck size={24} className="text-ivory" />
          </div>
      ...
      <section className="section-shell pb-16 lg:pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {shippingOptions.map((option, index) => {
            ...
            return (
              <div key={index} className="border border-brown/20 rounded-lg p-6 text-center hover:shadow-lg transition-shadow">
                ...
                <p className="text-brown-dark text-xl font-semibold mb-3">
                  {option.cost}
                </p>
      ...
      <section className="bg-brown/5 section-shell py-16 lg:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {locations.map((location, index) => (
            <div key={index} className="bg-ivory rounded-lg p-6">
              ...
              <ul className="space-y-1">
                {location.areas.map((area, idx) => (
                  <li key={idx} className="text-brown/70 text-xs">
                    • {area}
                  </li>
                ))}
              </ul>
      ...
      <section className="bg-brown-dark text-ivory section-shell py-16 lg:py-24">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 bg-ivory/10 rounded-full text-ivory font-bold mb-4">
                1
              </div>
      ...
      <section className="section-shell py-16 lg:pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            <h2 className="font-serif text-2xl lg:text-3xl font-light text-brown-dark mb-6">
              Secure & Beautiful Packaging
            </h2>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <Shield size={20} className="text-brown-dark mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-medium text-brown-dark mb-1">Tamper-Proof Security</h3>
                  <p className="text-brown/70 text-sm">All packages are sealed with security tape and tracking enabled</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Package size={20} className="text-brown-dark mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-medium text-brown-dark mb-1">Protective Packaging</h3>
                  <p className="text-brown/70 text-sm">Jewelry arrives in cushioned boxes with anti-tarnish protection</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Truck size={20} className="text-brown-dark mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-medium text-brown-dark mb-1">Insured Delivery</h3>
                  <p className="text-brown/70 text-sm">All shipments are fully insured and require signature upon delivery</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-brown/5 rounded-2xl p-8">
            <h3 className="font-serif text-xl font-light text-brown-dark mb-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-3">
                <span className="text-brown/60">Email:</span>
                <a href="mailto:help@amapels.com" className="text-brown-dark hover:text-brown">
                  help@amapels.com
                </a>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-brown/60">Phone:</span>
                <a href="tel:+234-809-123-4567" className="text-brown-dark hover:text-brown">
                  +234-809-123-4567
                </a>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-brown/60">Hours:</span>
                <span className="text-brown-dark">Mon-Sat 9AM-6PM WAT</span>
              </div>
            </div>
          </div>
        </div>
