      ...
      <div className="section-shell">
        ...
        >
          <div className="text-center mb-16">
            ...
            <h1 className="font-serif text-5xl font-light text-black-dark mb-6">Privacy Policy</h1>
          ...
          <div className="bg-white rounded-3xl border border-gold/30 p-8 md:p-12">
            <div className="prose prose-lg max-w-none">
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">1. Information We Collect</h2>
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">2. How We Use Your Information</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">3. Information Sharing</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">4. Data Security</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">5. Cookies and Tracking</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">6. Your Rights</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">7. Data Retention</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">8. International Transfers</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">9. Children's Privacy</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">10. Changes to This Policy</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section>
                <h2 className="font-serif text-2xl text-black-dark mb-4">11. Contact Us</h2>
