          ...
          <div className="bg-white rounded-3xl border border-gold/30 p-8 md:p-12">
            <div className="prose prose-lg max-w-none">
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">1. Acceptance of Terms</h2>
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">2. Use License</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">3. Product Information</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">4. Purchases and Payment</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">5. Shipping and Returns</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">6. Privacy Policy</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">7. Disclaimer</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">8. Limitations</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="font-serif text-2xl text-black-dark mb-4">9. Governing Law</h2>
                <p className="text-black/80 leading-relaxed mb-4">
              ...
              <section>
                <h2 className="font-serif text-2xl text-black-dark mb-4">10. Contact Information</h2>
